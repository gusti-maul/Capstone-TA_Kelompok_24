            ...
            <div class="card">
                <div class="card-header">
                    <nav aria-label="breadcrumb" class="main-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/kepalasekolah/{{$kepsek->id}}/profile">Profil Kepala Sekolah </a></li>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <form action="/kepalasekolah/{{$kepsek->id}}/update" method="POST" enctype="multipart/form-data">
                            @csrf
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" value="{{ $kepsek->nama }}">
                                                                    @error('nama')
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                    <input type="text" name="gelar" class="form-control @error('gelar') is-invalid @enderror" id="gelar" value="{{ $kepsek->gelar }}">
                                                                    @error('gelar')
                                                                    <div class=" invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                    <input type="number" name="nip" class="form-control @error('nip') is-invalid @enderror" id="nip" value="{{ $kepsek->nip }}">
                                                                    @error('nip')
                                                                    <div class=" invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-4 text-secondary">
                                                                    <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" id="tempat_lahir" value="{{ old('tempat_lahir', $kepsek->tempat_lahir ?? '') }}" placeholder="Masukkan Tempat Lahir">
                                                                    @error('tempat_lahir')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                                ...
                                                                <div class="col-sm-5 text-secondary">
                                                                    <input type="date" name="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" value="{{ old('tanggal_lahir', ($kepsek->tanggal_lahir ? date('Y-m-d', strtotime($kepsek->tanggal_lahir)) : '')) }}" placeholder="Pilih Tanggal Lahir">
                                                                    @error('tanggal_lahir')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                    <select class="form-control form-control" name="jenis_kelamin" id="jenis_kelamin">
                                                                        <option value="Laki-Laki" {{ old('jenis_kelamin', $kepsek->jenis_kelamin) == 'Laki-Laki' ? 'selected' : '' }}>Laki-Laki</option>
                                                                        <option value="Perempuan" {{ old('jenis_kelamin', $kepsek->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                                                    </select>
                                                                    @error('jenis_kelamin')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                    <select name="agama" class="form-control form-control form-select @error('agama') is-invalid @enderror" id="agama" required>
                                                                        ...
                                                                        <option value="Katolik" {{ $kepsek->agama == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                                                                        <option value="Buddha" {{ $kepsek->agama == 'Buddha' ? 'selected' : '' }}>Buddha</option>
                                                                        <option value="Kristen" {{ $kepsek->agama == 'Kristen' ? 'selected' : '' }}>Kristen</option>
                                                                        <option value="Lainya" {{ $kepsek->agama == 'Lainya' ? 'selected' : '' }}>Lainya</option>
                                                                    </select>
                                                                    @error('agama')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
