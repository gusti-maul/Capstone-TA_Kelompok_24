        ...
        <div class="main-body">
            ...
            <nav aria-label="breadcrumb" class="main-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/siswa">User</a></li>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f1979881b19b849a9c8499df909d">syahrulrama017@gmail.com</a>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a class="btn btn-info "  href="/siswa/{{$siswa->id}}/edit">Edit</a>
                                </div>
                            </div>
                        </div>
                    </div>
